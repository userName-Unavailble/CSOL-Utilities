...
namespace CSOL_Utilities
{
    ...
    public:
        ...
        void SetMaxWaitTimeInGameRoom(uint32_t t) { m_MaxWaitTimeInGameRoom = t > 60 ? t : 60; };
        uint32_t GetMaxWaitTimeInGameRoom() { return m_MaxWaitTimeInGameRoom; };
    private:
    ...
    private:
        ...
        inline void SetExtendedAutoPlayMode(bool toggle) noexcept { m_ExtendedAutoPlayMode = toggle; };
